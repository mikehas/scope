...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Perspective.create_date'
        db.add_column('directory_perspective', 'create_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Perspective.create_date'
        db.delete_column('directory_perspective', 'create_date')
