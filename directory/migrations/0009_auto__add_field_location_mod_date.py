...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.mod_date'
        db.add_column('directory_location', 'mod_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 9, 5, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.mod_date'
        db.delete_column('directory_location', 'mod_date')
