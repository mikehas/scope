...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Perspective.latitude'
        db.delete_column('directory_perspective', 'latitude')

        # Deleting field 'Perspective.longitude'
        db.delete_column('directory_perspective', 'longitude')

        # Adding field 'Perspective.lat'
        db.add_column('directory_perspective', 'lat',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=50, decimal_places=10),
                      keep_default=False)

        # Adding field 'Perspective.lng'
        db.add_column('directory_perspective', 'lng',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=50, decimal_places=10),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Perspective.latitude'
        raise RuntimeError("Cannot reverse this migration. 'Perspective.latitude' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Perspective.longitude'
        raise RuntimeError("Cannot reverse this migration. 'Perspective.longitude' and its values cannot be restored.")
        # Deleting field 'Perspective.lat'
        db.delete_column('directory_perspective', 'lat')

        # Deleting field 'Perspective.lng'
        db.delete_column('directory_perspective', 'lng')
    ...
    models = {
        ...
        'directory.location': {
            ...
            'mod_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 11, 0, 0)', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'directory.perspective': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '50', 'decimal_places': '10'}),
            'lng': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '50', 'decimal_places': '10'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['directory.Location']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
